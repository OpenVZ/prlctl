...
"    [--vnc-mode <auto | manual | off>] [--vnc-port <port>]\n"
"    [{--vnc-passwd <passwd> | --vnc-nopasswd}] [--vnc-address <address>]\n"
"    [--cpu-hotplug <on|off>]\n"
...
"		[--size <n>] [--iface <ide|scsi|virtio>] [--subtype <virtio-scsi|hyperv>]"
"		[--position <n>] [--mnt <path>]\n"
"	--device-add hdd --device <real_name>\n"
...
"	--backup-del <ID|all>\n"
"	--device-add cdrom {--device <name> | --image <image>}\n"
"		[--iface <ide|scsi>] [--subtype <virtio-scsi|hyperv>] [--passthr] [--position <n>]\n"
...

{
	...
	while (1) {
		...
		case CMD_WAIT:
			...
			break;
		case CMD_REPAIR:
			param.start_mode = PSM_VM_START_FOR_REPAIR;
			break;
